...
import PostContainer from "../../pages/study/post/PostContainer";
...
const AssignmentContainer = ({ onSubPageChange }) => {
  ...
  const isSubmissionsPage =
    location.pathname.includes("/submissions") && !submissionId;
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case "게시판":
        ...
        return <PostContainer onSubPageChange={handleSubPageChange} />;
      case "출석":
