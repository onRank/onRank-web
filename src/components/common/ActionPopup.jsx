        ...
        <button className="action-popup-button delete-button" onClick={handleDelete}>
          <span className="action-popup-icon delete-icon">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M5.5 11.5C5.78 11.5 6 11.28 6 11V6C6 5.72 5.78 5.5 5.5 5.5C5.22 5.5 5 5.72 5 6V11C5 11.28 5.22 11.5 5.5 11.5Z" fill="#FF3B30"/>
              <path d="M8 11.5C8.28 11.5 8.5 11.28 8.5 11V6C8.5 5.72 8.28 5.5 8 5.5C7.72 5.5 7.5 5.72 7.5 6V11C7.5 11.28 7.72 11.5 8 11.5Z" fill="#FF3B30"/>
              <path d="M10.5 11.5C10.78 11.5 11 11.28 11 11V6C11 5.72 10.78 5.5 10.5 5.5C10.22 5.5 10 5.72 10 6V11C10 11.28 10.22 11.5 10.5 11.5Z" fill="#FF3B30"/>
            </svg>
          </span>
