              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    border: 'none',
                    backgroundColor: attendance.attendanceStatus === 'PRESENT' ? '#E50011' : '#E5E5E5',
                    color: '#FFFFFF',
                    cursor: 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    border: 'none',
                    backgroundColor: attendance.attendanceStatus === 'ABSENT' ? '#000' : '#E5E5E5',
                    color: '#FFFFFF',
                    cursor: 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    border: 'none',
                    backgroundColor: attendance.attendanceStatus === 'LATE' ? '#007BFF' : '#E5E5E5',
                    color: '#FFFFFF',
                    cursor: 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    border: 'none',
                    backgroundColor: attendance.attendanceStatus === 'UNKNOWN' ? '#999' : '#E5E5E5',
                    color: '#FFFFFF',
                    cursor: 'pointer',
                    display: 'flex',
                    alignItems: 'center',
